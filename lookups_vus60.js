...
const url = 'https://returns-domain-manager-uat.apps-np.homedepot.com/returns/transaction/lookups';
const payload = JSON.stringify([
    {
      ...
      "featureFlags": {
        "enableStoreSpecialOrderItems": true
      }
    },
    {
      "emailData": {
        "emailAddress": "nathanbonnes@gmail.com",
        "sku": "161640",
        "uomCode": "CT",
        "quantity": "1"
      },
